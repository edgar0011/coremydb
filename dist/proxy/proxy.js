...
console.log('proxy', http_proxy_middleware_1.createProxyMiddleware); // eslint-disable-next: NextFunction-line @typescript-eslint/no-unused-vars
...
var router = function router(req) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      console.log('router:', req.url, req.path); // return routerMap[req.path]
...
var proxyOptions = {
  ...
  // },
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  onProxyError: function onProxyError(err, req, res) {
